...
public class AddDrivers extends JFrame implements ActionListener {
    ...
    private JTextField tfname, tfcompany, tfage, tfmodel, tflocation;
    private JComboBox typecombo, availablecombo, gendercombo;
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == add) {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null, "New Drivers Added Successfully");
                setVisible(false);
            } catch (Exception e) {
                e.printStackTrace();
            }
